...
<template>
  <div class="relative mb-3.5 h-8">
    <Search class="absolute left-4 top-1/2 h-[16px] w-[16px] -translate-y-1/2" :color="store === 'light' ? 'rgb(82 82 91 / 0.9)' : 'rgb(113 113 122)'" />
    <UiInput
      v-model="model"
      :placeholder="$t('top_menu.btns.search')"
      class="h-8 w-full border-0 border-none pl-[38px] pr-[40px] text-[14px] font-medium text-zinc-600 placeholder:font-medium placeholder:text-zinc-600 focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-zinc-100 xl:text-[13px] xl:placeholder:text-[13px] 2xl:text-[14px] 2xl:placeholder:text-[14px] dark:text-zinc-300 dark:placeholder:text-zinc-300"
    />
    <UiBadge
      variant="secondary"
